...
function Profiel() {
  ...
  useEffect(() => {
    const unsubscribe = auth.onAuthStateChanged(async (user) => {
      if (user) {
        setUserId(user.uid);
        const userDocRef = doc(db, 'logins', user.uid); // Adjust path as per your Firestore setup
  ...
  const handleSaveBio = async () => {
    if (userId) {
      const userDocRef = doc(db, 'logins', userId); // Adjust path as per your Firestore setup
        ...
        <section className='insta__acc_header'>
          ...
          <div className='insta__acc_about'>
            <div className="insta__acc_about_btns">
              ...
              <div className="insta__acc_about_btn insta__acc_about_btn-blue">Edit Foto</div>
